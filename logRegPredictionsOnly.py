...
#             print(genreToCoefficients[genreStrings[l]][0])
        ...
        if(scoresDict[maxScore]!=genreDict[songname] and genreDict[songname]!='NULL'): 
...
#         y_train, y_test = genreArray[train_index], genreArray[test_index]
    ...
    #     print(genreArray) 
        # print(X_train[1])
        numericalFeatures, blah = numericalFeaturesOnly(X_train, desFeat2) 
...
print(total)
print("Error")
print(float(incorrect)/float(total))
